                ...
                <div class="ml-2 relative">
                    <div class="absolute text-gray-600">
                        <svg viewBox="0 0 24 24"
                             class="fill-current w-5 h-5 mt-2 ml-2 hover:-rotate-1 hover:text-blue-400">
                    ...
                    <input type="text" name="search"
                           class="pl-8 w-56 h-8 bg-gray-200 rounded-full text-sm focus-within:shadow-none focus:ring-1 md:drop-shadow-xl"
